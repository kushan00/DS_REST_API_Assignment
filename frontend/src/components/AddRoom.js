...
import {AddNewRoom } from "../services/RoomServices";
...
const AddRoom = () => {
  ...
  const AddNewRoomData = async (e) =>{
    ...
    let data = await AddNewRoom(newdata);
    ...
    {
        alert("New Room added Successfull..");
        navigate("/AllRooms");
    }
  }
	...
	return (
		<div style={{ textAlign: "center" }}>
			...
			<div>
                <div >
                    <center >
                        <b style={{fontSize:"48px" , textDecoration:"underline"}}>-- Add New Room -- </b><br/><br/>
                    </center>
                    <div>
                <center>
                    <br/>
                    <form>
                        ...
                        <button onClick={(e)=>AddNewRoomData(e)} className="btn btn-primary" type="submit">
                        Insert
                        </button>
                    </form>         
                </center>
